...
export const CreateCustomerSchema = z.object({
  ...
  poutcome: z.enum(['failure', 'nonexistent', 'success', 'unknown', 'other']),
...
export const ListCustomersQuerySchema = ListQuerySchema.extend({
  ...
  job: z
    ...
    .optional(),
  marital: z.enum(['single', 'married', 'divorced', 'unknown']).optional(),
  education: z.enum(['primary', 'secondary', 'tertiary', 'unknown']).optional(),
  contact: z.enum(['cellular', 'telephone', 'unknown']).optional(),
